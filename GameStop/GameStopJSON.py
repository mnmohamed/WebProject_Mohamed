...
while i < 2:
    ...
    response.append({'Game Title': gameTitle, 'Game System': console, 'Publisher': publisher, 'Condition': condition,
                         'Price': price})

# Write response to JSON file
postingsFile = '/Users/laptop/Desktop/WebProject_Mohamed/SchTasks/' + today + '.GameStop.json'
